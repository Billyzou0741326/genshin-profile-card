...
const Card = React.forwardRef(
  (props: CardProps, ref: React.ForwardedRef<any>): JSX.Element => {
    ...
    return (
      <div
        ref={ref}
        className="h-64 w-full max-w-xl relative rounded-xl shadow-md"
        style={style}
      >
        <div className="flex flex-col h-full w-full p-4 justify-between text-white">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex flex-row gap-2">
              {/* Username (i.e 洛水居士) */}
              <span className="text-xl font-medium whitespace-nowrap block">
